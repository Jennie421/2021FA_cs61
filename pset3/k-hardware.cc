...
extern uint8_t _binary_obj_p_pfree_start[];
extern uint8_t _binary_obj_p_pfree_end[];
...
struct ramimage {
    ...
    { "pfree", _binary_obj_p_pfree_start, _binary_obj_p_pfree_end },
};
